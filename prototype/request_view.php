                        ...
                        <div class="col-md-12">
                            ...
                            <br/>
                                ...
                                <div class="card-header ">
                                    ...
                                    <p class="card-category">Ongoing and Pending Requests Section</p>
                                </div>
                                <div class="card-header ">
                                    <p class="card-category">Total: 2</p>
                                </div>
                                    ...
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody> <!-- if no ongoing requests, it should echo a description -->
                                            ...
                                            <tr> 
                                                ...
                                                <td>22 Dec 2023</td>
                                                <td>Ongoing</td>
                                                <td><a href="manage.php?id="><button>Manage</button></a></td>
                                            </tr>
