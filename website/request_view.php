                        ...
                        <div class="col-md-12">
                            ...
                            <br/>
                                ...
                                <div class="card-header ">
                                    ...
                                    <p class="card-category">Pending Requests Section</p>
                                </div>
                                <div class="card-header ">
                                    <?php
                                    $sql = "SELECT * from maintenance WHERE idmaintenance_status in (1,2);";
                                    $result = mysqli_query($conn,$sql);
                                    ...
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr> 
                                                ...
                                                <td><a href="more_info.php?id=<?php echo $x['idmaintenance']; ?>"><button>More Info</button></a></td> <!-- pressing a specific row opens a new page for a more detailed and organized form. -->
                                            </tr>
                                            <?php endif; ?>
