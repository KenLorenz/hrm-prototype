                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <br/>
                                ...
                                <div class="card-header">
                                    <?php
                                    $sql = "SELECT * FROM maintenance WHERE idmaintenance_status = 3";
                                    $denied_result = mysqli_query($conn,$sql);
                                    
                                    $sql = "SELECT * FROM maintenance WHERE idmaintenance_status = 4";
                                    $completed_result = mysqli_query($conn,$sql);

                                    
                                    ?>
                                    <p class="card-category">Completed: <?php echo mysqli_num_rows($completed_result) ?></p>
                                    <p class="card-category">Denied: <?php echo mysqli_num_rows($denied_result) ?></p>
                                    <?php
                                    
                                    mysqli_free_result($denied_result);
                                ...
                                <div class="card-body table-full-width table-responsive">
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody> <!-- if no ongoing requests, it should echo a description -->
                                            ...
                                            if($x['idmaintenance_status'] == 3 || $x['idmaintenance_status'] == 4):
                                            ...
                                            <tr> 
                                                ...
                                                <td><a href="logs_more_info.php?id=<?php echo $x['idmaintenance']; ?>"><button>More Info</button></a></td> <!-- pressing a specific row opens a new page for a more detailed and organized form. -->
                                            </tr>
                                            <?php endif; ?>
